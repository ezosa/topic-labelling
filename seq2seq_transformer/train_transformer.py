...
argparser.add_argument('--data_path', default='data/', type=str, help="path to training data")
...
train_src_filepath = os.path.join(args.data_path, "train_" + args.top_terms_strategy + ".source")
train_trg_filepath = os.path.join(args.data_path, "train_" + args.top_terms_strategy + ".target")

valid_src_filepath = os.path.join(args.data_path, "valid_" + args.top_terms_strategy + ".source")
valid_trg_filepath = os.path.join(args.data_path, "valid_" + args.top_terms_strategy + ".target")

test_src_filepath = os.path.join(args.data_path, "test_" + args.top_terms_strategy + ".source")
test_trg_filepath = os.path.join(args.data_path, "test_" + args.top_terms_strategy + ".target")
